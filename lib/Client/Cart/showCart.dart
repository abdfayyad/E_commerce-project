...
import 'package:project_zain2/Client/Cart/bloc/cubit.dart';
        ...
        builder: (context,state){
          return Scaffold(
            ...
            body: Padding(
              ...
              child:showCartModel!=null? GridView.builder(
                gridDelegate:
                ...
                itemCount: showCartModel!.cartItems!.products!.length, // Total number of items
                itemBuilder:
                      ...
                      child: Column(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.network(
                              '${showCartModel!.cartItems!.products![index].productImage}',
                          ...
                          Padding(
                            ...
                            const EdgeInsets.symmetric(
                                horizontal: 8.0),
                            child: Text(
                              '${showCartModel!.cartItems!.products![index].productName}',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  '\$${showCartModel!.cartItems!.products![index].productPrice}.00',
                                  style:const TextStyle(
                                    color:
                                    Colors.deepOrange,
                                    fontSize: 16.0,
